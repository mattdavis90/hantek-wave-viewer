...
hantek_t::hantek_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent, hantek_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_header = nullptr;
    m_data1 = nullptr;
...
hantek_t::header_t::header_t(kaitai::kstream* p__io, hantek_t* p__parent, hantek_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
    m__unnamed2 = nullptr;
    m_channel1 = nullptr;
...
void hantek_t::header_t::_read() {
    ...
    if (!(magic() == std::string("\x6C\x77\x66\x00", 4))) {
        throw kaitai::validation_not_equal_error<std::string>(std::string("\x6C\x77\x66\x00", 4), magic(), _io(), std::string("/types/header/seq/0"));
    }
...
hantek_t::channel_t::channel_t(kaitai::kstream* p__io, hantek_t::header_t* p__parent, hantek_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
    _read();
}
...
hantek_t::footer_t::footer_t(kaitai::kstream* p__io, hantek_t* p__parent, hantek_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
    _read();
}
...
void hantek_t::footer_t::_read() {
    ...
    if (!(magic() == std::string("\x78\x56\x34\x12", 4))) {
        throw kaitai::validation_not_equal_error<std::string>(std::string("\x78\x56\x34\x12", 4), magic(), _io(), std::string("/types/footer/seq/0"));
    }
}
